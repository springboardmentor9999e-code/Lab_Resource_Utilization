        ...
        <div style={styles.container}>
            ...
            <div style={styles.sidebar}>
                <div style={styles.sidebarHeader}>
                    <div>
                        <h2 style={styles.sidebarTitle}>Researcher</h2>
                        <p style={styles.sidebarSubtitle}>Lab Resource Management</p>
                    </div>
                </div>
            ...
            <div style={styles.mainContent}>
                    ...
                    <div>
                        ...
                        <div style={styles.statsGrid}>
                            <div style={styles.statCard("#3b82f6")}>
                                <span style={styles.statTitle}>Total Equipment Available</span>
                                <span style={styles.statValue}>{dashboard.totalEquipment || equipmentList.length}</span>
                            </div>

                            <div style={styles.statCard("#f59e0b")}>
                                <span style={styles.statTitle}>My Total Bookings</span>
                                <span style={styles.statValue}>{dashboard.myBookings || bookingList.length}</span>
                            </div>

                            <div style={styles.statCard("#10b981")}>
                                <span style={styles.statTitle}>Approved Reservations</span>
                                <span style={styles.statValue}>
                                    {dashboard.approvedBookings || bookingList.filter(b => b.status === "Approved").length}
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                {activePage === "bookings" && (
                    <div>
                        ...
                        <div style={styles.card}>
                            <h3 style={styles.cardTitle}>Reservation History</h3>
                        ...
                        <div style={{ ...styles.card, maxWidth: "500px" }}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                                <div style={styles.inputGroup}>
                                    ...
                                    <input
                                        type="text"
                                        value={userProfile.username || "Researcher"}
                                        disabled
                                ...
                                <div style={styles.inputGroup}>
                                    ...
                                    <input
                                        type="email"
                                        value={userProfile.email || "researcher@lab.org"}
                                        disabled
                                        style={{ ...styles.input, backgroundColor: "#f1f5f9" }}
                                    />
                                </div>
                                <div style={styles.inputGroup}>
                                    ...
                                    <input
                                        type="text"
                                        value={userProfile.role || "Researcher"}
                                        disabled
                                        style={{ ...styles.input, backgroundColor: "#f1f5f9" }}
                                    />
                                </div>
