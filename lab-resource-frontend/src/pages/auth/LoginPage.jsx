...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (searchParams.get('error')) {
      toast.error('Your account may have been deactivated. Please contact your administrator.', { duration: 6000 });
    }
  }, [searchParams]);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-primary-100">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Lab Resource Utilization Platform</p>
        </div>
        ...
        <div className="card">
          ...
          <div className="mt-4">
            ...
            <button
              ...
              className="w-full mt-4 flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
            >
